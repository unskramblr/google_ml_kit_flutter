...
class GalleryView2 extends StatefulWidget {
  ...
  final String title;
  final String? text;
  final Function(InputImage inputImage, File path) onImage;
  final Function()? onDetectorViewModeChanged;
  final Widget customPaint;

  @override
  State<GalleryView2> createState() => _GalleryView2State();
}
...
class _GalleryView2State extends State<GalleryView2> {
  ...
  Widget _galleryBody() {
    print("Received text as ${widget.title}");
    return widget.title != 'Display'
  ...
  Future _processFile(String path) async {
    ...
    widget.onImage(inputImage, _image!);
  }
}
